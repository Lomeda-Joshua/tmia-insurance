...
///////////////////////// FIRST LOAD SCRIPT ////////////////////////////////////
  $(document).ready( function () {
    ...
    $(".toggle-secret").click(function() {
        ...
        if (isMasked) {
          ...
          $("#secret").text("✱".repeat(secretkey.length));
        }
  ...
  function initializeSecretKey() {
    ...
    if ($(".toggle-secret").hasClass('fa-eye-slash')) {
      $(".toggle-secret").removeClass('fa-eye-slash').addClass('fa-eye');
    }
  }
///////////////////////// FIRST LOAD SCRIPT ////////////////////////////////////
...
////////////////////////// BUTTONS CLICKED /////////////////////////////////
  $(document).on("click","#btnverify",function(){
    ...
    if(code == '' || code == null){
      ...
      swal({
        title: "Warning!",
        text: "Please enter the code from your app.",
        type: "warning",
    ...
    $.ajax({
      url : "2fauthenticator_verify.php",
      type: "POST",
      data : value,
      success: function(data)
      {
  ...
  $(document).on("click","#btncreate",function(){
    $.ajax({
      url: "2fauthenticator_create.php",
      dataType: 'json',
      cache: false,
      success: function(data)
      {
        ...
        // Add new qrcode
        $(".qrcode > img").remove();
        $(".qrcode").append("<img src="+ data.qrCodeUrl +" alt='QR Code'>")
        $("#code").val('');
        isMasked = true;
        initializeSecretKey();
        $("#code").focus();
