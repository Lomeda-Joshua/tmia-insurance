  ...
  $.ajax({
    ...
    success: function(data){
      ...
      $.each(data, function(i, value) {
        ...
        // Safe date handling
        if (value.Start_Date) {
          const safeBDate = new Date(value.Start_Date);
          if (!isNaN(safeBDate)) {
            $("#dpstartdate").datepicker("setDate", safeBDate);
          }
        }
...
function getAttachment(insuranceno) {
  $.ajax({
    ...
    success:function(data){
      ...
      $("#file").fileinput({
        uploadUrl: "./file_rb_upload.php",
        deleteUrl: './file_rb_delete.php',
        //initialPreviewDownloadUrl: './file_rb_download.php',
        uploadAsync: false,
      ...
      $('.btndownload').on('click', function() {
        ...
        swal({
          ...
          if (isConfirm) {
            window.location = 'file_rb_download.php?key='+key;
  ...
  function(isConfirm) {
    if (isConfirm) {
      $.post("send_variable.php", { insuranceno:insuranceno,csno:csno,plateno:plateno }) .done(function(data) {
        window.location = 'file_rb_download_all.php';
        swal({
          title: "Downloaded!",
...
$(document).on("click", "#btnupdatecust", function () {
  ...
  // ======================================================
  $.ajax({
    url: "renewal_business_update.php",
    method: "POST",
    data: formdata,
    processData: false,
    contentType: false,
