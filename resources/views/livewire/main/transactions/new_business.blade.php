    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-warning">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <input type="text" id="txtsearch" class="form-control input-sm clearable"
                                            placeholder="Press <Enter> key or click icon search button to search."
                                            autocomplete="off">
                            ...
                            <div class="col-md-2">
                                <div style="padding: 10px 0; width: 85px;">
                                    <label id="btnrefresh" class="btn btn-box-tool"
                                        style="font-size: 15px !important; display: block;"><i
                    ...
                    @if (Auth::user()->User_Level_ID == 1)
                        <div class="row">
                            <div class="btnactionud pull-right" data-ise-staff="{{ route('insurance_staff.data') }}">
                                <button type="button" id="btnadd" class="btn btn-box-tool"
                ...
                <div class="box-body table_trans" style="max-width:100%;" data-trans-table="{{ route('newbusiness.data') }}">
                ...
                <div class="box box-solid">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select id="cboise" class="form-control input-sm"
                                                    required="required" data-error="Insurance Staff is required.">
                    ...
                    <div class="box-footer with-border">
                        <div class="pull-right">
                            <button type="button" id="btncancelise" class="btn btn-success"><i
                                    class="fa fa-ban"></i> Cancel</button>
                            <button type="button" id="btnselectise" class="btn btn-success"><i
                                    class="fa-regular fa-circle-check"></i> Select</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="box-body" style="max-width:100%;">
                        ...
                        <form id="multiStepForm">
                            ...
                            <div class="page active" id="page1">
                                <div class="box box-solid">
                                    <div class="box-header with-border">
                                        <h2 class="box-title"><i class="fa-regular fa-circle-user"></i> Customer
                                            Information</h2>
                                    </div>
                                    <div class="box-body" style="max-width:100%;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" id="txtcustno"
                                                                        class="form-control input-sm"
                                                                        placeholder="Auto Generated" disabled>
                                                                    <input type="hidden" id="txtcustnoupload"
                                                                        class="form-control input-sm">
                                                                    <span class="input-group-btn">
                                                                        <button type="button" id="btnfindcustomer"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cbogroup" class="form-control input-sm"
                                                                    required="required"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="txtcustfname"
                                                                        class="form-control input-sm"
                                                                        required="required"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="txtcustmname"
                                                                        class="form-control input-sm"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="txtcustlname"
                                                                        class="form-control input-sm"
                                                                        required="required"
                                                                        data-error="Last Name is required." disabled>
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="txtcustsname"
                                                                        class="form-control input-sm"
                                                                        placeholder="Optional Ex. Jr, II & etc."
                                                                        disabled>
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6 birth-date">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group date">
                                                                    ...
                                                                    <input id="dpbirthdate" type="text"
                                                                        class="form-control input-sm pull-right"
                                                                        required="required"
                                                                        data-error="Birth Date  is required." disabled>
                                                                </div>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" id="txtemailadd"
                                                                        class="form-control input-sm"
                                                                        required="required"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="txtaddress" class="form-control input-sm" placeholder="Address here!" rows="3"
                                                                    required="required" data-error="Address is required." disabled></textarea>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cboregion" class="form-control input-sm"
                                                                    required="required"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cboprovince" class="form-control input-sm"
                                                                    required="required"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cbocity" class="form-control input-sm"
                                                                    required="required"
                                                                    data-error="City / Municipal is required."
                                                                    disabled>
                                                                    <option Value="">PLEASE SELECT</option>
                                                                </select>
                                                                <div class="help-block with-errors"></div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cbobrgy" class="form-control input-sm"
                                                                    required="required"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="txtzipcode">Zip Code / Postal Code
                                                                    *</label>
                                                                <input type="text" id="txtzipcode"
                                                                    class="form-control input-sm" required="required"
                                                                    data-error="Zip Code / Postal Code is required."
                                                                    disabled>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cbocountry" class="form-control input-sm"
                                                                    required="required"
                                    ...
                                    <div class="box-footer with-border">
                                        <div class="pull-right">
                                            <button type="button" id="nextBtn" data-toggle="tooltip"
                                                data-placement="top" title="Next" class="btn btn-success"><i
                                                    class="fa-solid fa-forward-step"></i> Next</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <span class="input-group-btn">
                                                                        <button type="button" id="btnfindvehicle"
                                                                            data-toggle="tooltip" data-placement="top"
                                                                            title="Find Vehicle"
                                                                            class="btn btn-success btn-flat"><i
                                                                                class="fa fa-search"></i></button>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="txtmodelyear"
                                                                    class="form-control input-sm" required="required"
                            ...
                            <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group date">
                                                                    ...
                                                                    <input id="dpvsidate" type="text"
                                                                        class="form-control input-sm pull-right"
                                                                        required="required"
                                                                        data-error="VSI Date is required." disabled>
                                                                </div>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="help-block with-errors"></div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group date">
                                                                    ...
                                                                    <input id="dpreldate" type="text"
                                                                        class="form-control input-sm pull-right"
                                                                        required="required"
                                                                        data-error="Released Date is required."
                                                                        disabled>
                                                                </div>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="dptechdate">Technical Date
                                                                    (Optional)</label>
                                                                <div class="input-group date">
                                                                    <div class="input-group-addon">
                                                                        <i class="fa fa-calendar"></i>
                                                                    </div>
                                                                    <input id="dptechdate" type="text"
                                                                        class="form-control input-sm pull-right"
                                                                        disabled>
                                                                </div>
                                                                <div class="help-block with-errors"></div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cbobodytype" class="form-control input-sm"
                                                                    required="required"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="txttransmission">Power Transmission
                                                                    *</label>
                                                                <input type="text" id="txttransmission"
                                                                    class="form-control input-sm" required="required"
                                                                    data-error="Power Transmission is required."
                                                                    disabled>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cbofueltype" class="form-control input-sm"
                                                                    required="required"
                              ...
                              <div class="form-group">
                                ...
                                <div class="help-block with-errors"></div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="cboprodclass">Product Classification
                                                                    *</label>
                                                                <select id="cboprodclass"
                                                                    class="form-control input-sm" required="required"
                                                                    data-error="Product Classification is required."
                                                                    disabled>
                                                                    <option Value="">PLEASE SELECT</option>
                                                                </select>
                                                                <div class="help-block with-errors"></div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cboowntype" class="form-control input-sm"
                                                                    required="required"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="txtvoname"
                                                                    class="form-control input-sm" required="required"
                                                                    data-error="Vehicle Owner Name is required."
                                                                    disabled>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="txtmpname"
                                                                    class="form-control input-sm" required="required"
                                                                    data-error="Marketing Professional is required."
                                                                    disabled>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="box-footer with-border">
                                        <div class="pull-left">
                                            <button type="button" id="prevBtn" data-toggle="tooltip"
                                                data-placement="top" title="Previous" class="btn btn-success"><i
                                                    class="fa-solid fa-backward-step"></i> Previous</button>
                                        </div>
                                        <div class="pull-right">
                                            <button type="button" id="nextBtn" data-toggle="tooltip"
                                                data-placement="top" title="Next" class="btn btn-success"><i
                                ...
                                <div class="box box-solid">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="txtgrosspremium"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="txtnetremittance"
                                                                class="form-control input-sm" value="0.00"
                                                                required="required"
                                                                data-error="Net Remittance is required." disabled>
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="txtcommission"
                                                                class="form-control input-sm" value="0.00"
                                                                style="font-weight: bold; background: #F3F3F3;"
                                                                required="required"
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="radio-group">
                                                            <label class="custom-radio">
                                                                <input type="radio" name="rdoptiontype"
                                                                    value="FREE" checked>
                                                        ...
                                                        <tr>
                                                            <td data-label="" style="text-align: left;">
                                                                <label class="custom-checkbox">
                                                                    ...
                                                                    <span class="checkbox-label">Installment
                                                                        Payment</span>
                                                                </label>
                                                            </td>
                                                            ...
                                                            <td data-label="" id="installpay-mpay" hidden>
                                                                <div class="form-group">
                                                                    <label for="txtmonthpay">Monthly
                                                                        Payment(₱/month)</label>
                                                                    <input type="text" id="txtmonthpay"
                                                                        style="font-weight: bold; background: #F3F3F3;"
                                                                        disabled>
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                ...
                                                <div class="box-body" style="max-width:100%;">
                                                    <div class="payment-info-n">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="row pay-section-n">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="cbopaytype-n">Payment Type
                                                                                *</label>
                                                                            <select id="cbopaytype-n"
                                                                                class="form-control input-sm" required
                                                                                data-error="Payment Type is required."
                                                                                disabled>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="credit-card">
                                                                            <div class="cc-header">
                                                                                ...
                                                                                <div class="cc-icons">
                                                                                    <img src="{{ asset('tmia-assets/images/credit/visa.svg') }}"
                                                                                        alt="visa">
                                                                                    <img src="{{ asset('tmia-assets/images/credit/mastercard.svg') }}"
                                                                                        alt="mastercard">
                                                                                    <img src="{{ asset('tmia-assets/images/credit/jcb.svg') }}"
                                                                                        alt="jcb">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label for="txtccno-n">Card No.
                                                                                            *</label>
                                                                                        <input type="text"
                                                                                            id="txtccno-n"
                                                                                            class="form-control input-sm"
                                                                                            required
                                                                                            data-error="Card No. is required."
                                                                                            disabled>
                                                                                        <div
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="txtccholder-n">Holder
                                                                                            Name *</label>
                                                                                        <input type="text"
                                                                                            id="txtccholder-n"
                                                                                            class="form-control input-sm"
                                                                                            required
                                                                                            data-error="Holder Name is required."
                                                                                            disabled>
                                                                                        <div
                                                                                            class="help-block with-errors">
                                                                                        </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="txtccexpirydate-n">Expiry
                                                                                            Date (MM/YY) *</label>
                                                                                        <input type="text"
                                                                                            id="txtccexpirydate-n"
                                                                                            class="form-control input-sm"
                                                                                            required
                                                                                            data-error="Expiry Date is required."
                                                                                            disabled>
                                                                                        <div
                                                                                            class="help-block with-errors">
                                                                                        </div>
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label for="txtccvv-n">CVV /
                                                                                            CVC *</label>
                                                                                        <input type="text"
                                                                                            id="txtccvv-n"
                                                                                            class="form-control input-sm"
                                                                                            required
                                                                                            data-error="CVV / CVC is required."
                                                                                            disabled>
                                                                                        <div
                                                                                            class="help-block with-errors">
                                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="post-dated-check">
                                                                            <div class="pdc-header">
                                                                                ...
                                                                                <div class="pdc-icons">
                                                                                    <img src="{{ asset('tmia-assets/images/credit/check.png') }}"
                                                                                        alt="cheque">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label for="txtpdcno-n">Check
                                                                                            No. *</label>
                                                                                        <input type="text"
                                                                                            id="txtpdcno-n"
                                                                                            class="form-control input-sm"
                                                                                            required
                                                                                            data-error="Check No. is required."
                                                                                            disabled>
                                                                                        <div
                                                                                            class="help-block with-errors">
                                                                                        </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="txtpdcholdername-n">Account
                                                                                            Holder Name *</label>
                                                                                        <input type="text"
                                                                                            id="txtpdcholdername-n"
                                                                                            class="form-control input-sm"
                                                                                            required
                                                                                            data-error="Account Holder Name is required."
                                                                                            disabled>
                                                                                        <div
                                                                                            class="help-block with-errors">
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="input-group date">
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                class="form-control input-sm pull-right"
                                                                                                required="required"
                                                                                                data-error="Check Date is required."
                                                                                                disabled>
                                                                                        </div>
                                                                                        <div
                                                                                            class="help-block with-errors">
                                                                ...
                                                                <div class="row ew-section-n" style="display: none;">
                                                                    <div class="col-md-12">
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label for="cboewallet-n">E-Wallet Type
                                                                                    *</label>
                                                                                <select id="cboewallet-n"
                                                                                    class="form-control input-sm"
                                                                                    required
                                                                                    data-error="E-Wallet Type is required."
                                                                                    disabled>
                                                                                    <option value=" ">PLEASE
                                                                                        SELECT</option>
                                                                                </select>
                                                                        ...
                                                                        <div class="col-md-8 ew-icons-col">
                                                                            <div class="ew-icons">
                                                                                <img id="pgcash-n"
                                                                                    src="{{ asset('tmia-assets/images/e-wallet/gcash.svg') }}"
                                                                                    alt="gcash">
                                                                                <img id="pmaya-n"
                                                                                    src="{{ asset('tmia-assets/images/e-wallet/maya.svg') }}"
                                                                                    alt="maya">
                                                                                <img id="ptwallet-n"
                                                                ...
                                                                <div class="row term-amount-section-n">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="txtpayterms-n"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="txtpayamount-n">Amount
                                                                                *</label>
                                                                            <input type="text" id="txtpayamount-n"
                                                                                class="form-control input-sm" required
                                                                ...
                                                                <div class="row btnadd-section-n">
                                                                    <div class="col-md-12 text-right">
                                                                        <label type="button" id="btnaddpay-n"
                                                        ...
                                                        <div class="table-responsive">
                                                            <table id="table_payment-n" class="table m-0"
                                    ...
                                    <th>CC CVV</th> -->
                                                            ...
                                                            <p style="font-size:12px;font-style: italic;">
                                                                <b>Note:</b> To modify or update a payment, double-click
                                                                the row you wish to edit. After making the necessary
                                                                changes in the input fields, click the ‘Add Payment’
                                                                button to save the updates to the payment list.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="page" id="page4">
                                <div class="box box-solid">
                                    <div class="box-header with-border">
                                        <h2 class="box-title"><i class="fa fa-building-shield"></i> Insurer
                                            Information</h2>
                                    </div>
                                    <div class="box-body" style="max-width:100%;">
                                        <div class="insurer-info">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cboinstype" class="form-control input-sm"
                                                                    required="required"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cboinsco" class="form-control input-sm"
                                                                    required="required"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="dpstartdate">Start / Inception Date
                                                                    *</label>
                                                                <div class="input-group date">
                                                                    <div class="input-group-addon">
                                                                        <i class="fa fa-calendar"></i>
                                                                    </div>
                                                                    <input id="dpstartdate" type="text"
                                                                        class="form-control input-sm pull-right"
                                                                        required="required"
                                                                        data-error="Start / Inception Date is required.">
                                                                </div>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="txtpolicyno"
                                                                    class="form-control input-sm" required="required"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group date">
                                                                    ...
                                                                    <input id="dpissuedate" type="text"
                                                                        class="form-control input-sm pull-right"
                                                                        required="required"
                                                                        data-error="Issue Date is required.">
                                                                </div>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="dppexpiredate">Policy Expiration Date
                                                                    *</label>
                                                                <div class="input-group date">
                                                                    <div class="input-group-addon">
                                                                        <i class="fa fa-calendar"></i>
                                                                    </div>
                                                                    <input id="dppexpiredate" type="text"
                                                                        class="form-control input-sm pull-right"
                                                                        required="required"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cbomortgage"
                                                                    class="form-control input-sm"
                                                                    required="required"
                                                                    data-error="Mortgage is required.">
                                                                    <option Value="">PLEASE SELECT</option>
                                                                </select>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                    ...
                                    <div class="box-footer with-border">
                                        <div class="pull-left">
                                            <button type="button" id="prevBtn" data-toggle="tooltip"
                                                data-placement="top" title="Save" class="btn btn-success"><i
                                                    class="fa-solid fa-backward-step"></i> Previous</button>
                                        </div>
                                        <div class="pull-right">
                                            <button type="button" id="nextBtn" data-toggle="tooltip"
                                ...
                                <div class="box box-solid">
                                    ...
                                    <div class="box-body" style="max-width:100%;">
                                        <div class="final-submit">
                                            <h4>Please review your information one last time. If everything looks
                                                correct, click "Submit" to proceed.</h4>
                                        </div>
                                    </div>
                                    <div class="box-footer with-border">
                                        <div class="pull-left">
                                        ...
                                        <div class="pull-right">
                                            <button type="button" id="btnsubmit" data-toggle="tooltip"
                                                data-placement="top" title="Submit" class="btn btn-success"><i
                                                    class="fa-solid fa-forward-step"></i> Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="modal-customerlist" aria-hidden="false" role="dialog"
                ...
                <div class="box">
                        ...
                        <div class="row">
                            <div class="col-md-6" style="padding: 0; margin-bottom: 5px;">
                                <div class="form-group">
                                    <label>Search </label>
                                    <div class="input-group input-group-sm">
                                        <input type="text" id="txtcustomersearch"
                                            class="form-control input-sm clearable-s"
                                            placeholder="Press <Enter> key or click icon search button to search."
                                            autocomplete="off">
                                        <span class="input-group-btn">
                                            <button type="button" id="btnfindcust"
                                                class="btn btn-success btn-flat"><i
                                                    class="fa fa-search"></i></button>
                                        </span>
                                    </div>
                    ...
                    <div class="box-body">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs customertab">
                                <li class="active"><a href="#tmiatab" data-toggle="tab">TMIA Customer List</a>
                                </li>
                                <li><a href="#uploadtab" data-toggle="tab">Uploaded Customer List (EDAF/SAP)</a>
                                </li>
                            </ul>
                    ...
                    <div class="box-footer with-border">
                        <div class="pull-right">
                            <button type="button" id="btncustselect" data-toggle="tooltip" data-placement="top"
                                title="Go" class="btn btn-success"><i class="fa-solid fa-clipboard-check"></i>
                                Go</button>
                        </div>
                    </div>
                </div>
            ...
            <!-- MODAL VEHICLE LIST -->
            <div id="modal-vehiclelist" aria-hidden="false" role="dialog"
          ...
          <h2 class="box-title">Vehicle List</h2>
                    ...
                    <div class="box-body">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs customervehtab">
                                <li class="active"><a href="#tmiavehtab" data-toggle="tab">TMIA Customer Vehicle
                                        List</a></li>
                                <li><a href="#uploadvehtab" data-toggle="tab">Uploaded Customer Vehicle List
                                        (EDAF/SAP)</a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="active tab-pane" id="tmiavehtab">
                                    <div class="box-body">
                                        <table id="table_vehiclelist"
                                            class="table table-striped table-bordered table-hover nowrap"
                                            style="width:100%">
                                            <thead>
                                                <tr class="tableheader">
                    ...
                    <div class="box-footer with-border">
                        <div class="pull-right">
                            <button type="button" id="  " data-toggle="tooltip" data-placement="top"
                                title="Go" class="btn btn-success"><i class="fa-solid fa-clipboard-check"></i>
                                Go</button>
                        </div>
                    </div>
                ...
                <div class="box box-solid">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="txtccholder"
                                                                class="form-control input-sm" required
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="txtccexpirydate"
                                                                class="form-control input-sm" required
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-dated-check">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="txtpdcholdername">Account Holder Name
                                                                *</label>
                                                            <input type="text" id="txtpdcholdername"
                                                                class="form-control input-sm" required
                                                                data-error="Account Holder Name is required."
                                                                disabled>
                                                            <div class="help-block with-errors"></div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="txtpdcbankname"
                                                                class="form-control input-sm" required
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date">
                                                                ...
                                                                <input id="dppdccheckdate" type="text"
                                                                    class="form-control input-sm pull-right"
                                                                    required="required"
                                    ...
                                    <div class="row term-amount-section">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtpayterms"
                                                    class="form-control input-sm" disabled>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtpayamount"
                                                    class="form-control input-sm" required
                  ...
                  <th>CC CVV</th> -->
                                ...
                                <table class="table m-0">
                                    <thead>
                                        <tr>
                                            <th style="text-align:right; background-color: #f4f4f4;">Total Premium:
                                            </th>
                                            <th id="tfoot_tpremium"
                                                style="text-align:right; background-color: #f4f4f4;">0.00</th>
                                            <th style="text-align:right; background-color: #f4f4f4;">Total Amount:
                                            </th>
                                            <th id="tfoot_total"
                                                style="text-align:right; background-color: #f4f4f4;">0.00</th>
                                            <th style="text-align:right; background-color: #f4f4f4;">Total Balance:
                                            </th>
                                            <th id="tfoot_balance"
                                                style="text-align:right; background-color: #f4f4f4;">0.00</th>
                                        </tr>
                                ...
                                <p style="font-size:12px;font-style: italic;">
                                    <b>Note:</b> To modify or update a payment, double-click the row you wish to edit.
                                    After making the necessary changes in the input fields, click the ‘Add Payment’
                                    button to save the updates to the payment list.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="box-footer with-border">
                        <div class="pull-right">
                            <button type="button" id="btneditpay" class="btn btn-success"><i
                                    class="fa fa-edit"></i> Edit</button>
                            <button type="button" id="btnclosepay" class="btn btn-success"><i
                                    class="fa fa-close"></i> Close</button>
                            <label type="button" id="btncancelpay" class="btn btn-success"
                                style="display:none;"><i class="fa fa-ban"></i> Cancel</label>
                            <label type="button" id="btnupdatepay" class="btn btn-success"
                                style="display:none;"><i class="fa fa-save"></i> Update Info.</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="modal-modify-status" aria-hidden="false" role="dialog"
                class="iziModal isAttached hasScroll">
                <div class="box box-solid">
                    <div class="box-body" style="max-width:100%;">
                        <div class="insurer-info">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="cbotransstatus" class="form-control input-sm"
                                                    required="required" data-error="Status is required." disabled>
                                                    <option Value="">PLEASE SELECT</option>
                                                </select>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="txttranssremarks" class="form-control input-sm" placeholder="Address here!" rows="2"
                                                    disabled></textarea>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                    ...
                    <div class="box-footer with-border">
                        <div class="pull-right">
                            <button type="button" id="btneditstatus" class="btn btn-success"><i
                                    class="fa fa-edit"></i> Edit</button>
                            <button type="button" id="btnclosestatus" class="btn btn-default"
                                data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                            <button type="button" id="btncancelstatus" class="btn btn-danger"><i
                                    class="fa fa-ban"></i> Cancel</button>
                            <button type="button" id="btnupdatestatus" class="btn btn-primary"><i
            ...
            <div id="modal-modify-netrem" aria-hidden="false" role="dialog"
                class="iziModal isAttached hasScroll">
                <div class="box box-solid">
                    <div class="box-body" style="max-width:100%;">
                        <div class="insurer-info">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtinsgpremium"
                                                    class="form-control input-sm" required="required"
                                                    data-error="Gross Premium is required." disabled>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtnetrem" class="form-control input-sm"
                                                    required="required" data-error="Net Rem is required." disabled>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtinscommission"
                                                    class="form-control input-sm" disabled>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                    ...
                    <div class="box-footer with-border">
                        <div class="pull-right">
                            <button type="button" id="btneditnetrem" class="btn btn-success"><i
                                    class="fa fa-edit"></i> Edit</button>
                            <button type="button" id="btnclosenetrem" class="btn btn-success"><i
                                    class="fa fa-close"></i> Close</button>
                            <button type="button" id="btncancelnetrem" class="btn btn-success"
                                style="display:none;"><i class="fa fa-ban"></i> Cancel</button>
                            <button type="button" id="btnupdatenetrem" class="btn btn-success"
            ...
            <div id="modal-call" aria-hidden="false" role="dialog" class="iziModal isAttached hasScroll">
                <div class="box box-solid">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtinsuranceno"
                                                    class="form-control input-sm">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtsfcontactno"
                                                    class="form-control input-sm" disabled>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtsfvin" class="form-control input-sm"
                                                    disabled>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="cbomodecomm" class="form-control input-sm"
                                                    required="required" data-error="Call Status is required."
                                                    disabled>
                                                    <option Value="">PLEASE SELECT</option>
                                                </select>
                                                <div class="help-block with-errors"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="cbocallstatus" class="form-control input-sm"
                                                    required="required" data-error="Call Status is required."
                                                    disabled>
                                                    <option Value="">PLEASE SELECT</option>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="cbocallreason" class="form-control input-sm"
                                                    required="required" data-error="Call Reason is required."
                                                    disabled>
                                                    <option Value="">PLEASE SELECT</option>
                                                </select>
                                                <div class="help-block with-errors"></div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input id="dpppdate" type="text"
                                                        class="form-control input-sm pull-right" required="required"
                                                        data-error="Promised Pay Date is required." disabled>
                                                </div>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="txtcallremarks" class="form-control input-sm" placeholder="Call Remarks here!" rows="2"
                                                    disabled></textarea>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                    ...
                    <div class="box-footer with-border">
                        <div class="pull-right">
                            <button type="button" id="btneditcall" class="btn btn-success"><i
                                    class="fa fa-edit"></i> Edit</button>
                            <button type="button" id="btnclosecall" class="btn btn-success"><i
                                    class="fa fa-close"></i> Close</button>
                            <button type="button" id="btncancelcall" class="btn btn-success"
                                style="display:none;"><i class="fa fa-ban"></i> Cancel</button>
                            <button type="button" id="btnupdatecall" class="btn btn-success"
                                style="display:none;"><i class="fa fa-save"></i> Update</button>
                        </div>
                    </div>
                </div>
