...
<!-- jQuery-JSON v2.6.0 -->
<script type="text/javascript" src="{{ asset('tmia-assets/plugins/jquery-json/dist/jquery.json.min.js') }}"></script>
...
<!-- AdminLTE App -->
<script type="text/javascript" src="{{ asset('tmia-assets/js/app.min.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('tmia-assets/plugins/chartjs/dist/chartjs-plugin-datalabels.min.js') }}"></script>
...
<!-- iziModal v1.6.1 JS -->
<script type="text/javascript" src="{{ asset('tmia-assets/plugins/izimodal/js/iziModal.min.js') }}"></script>

<!-- File Upload JS -->
<script type="text/javascript" src="{{ asset('tmia-assets/plugins/fileupload/js/plugins/buffer.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('tmia-assets/plugins/fileupload/js/plugins/filetype.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('tmia-assets/plugins/fileupload/js/plugins/piexif.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('tmia-assets/plugins/fileupload/js/plugins/sortable.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('tmia-assets/plugins/fileupload/js/fileinput.min.js') }}"></script>
